...
export default function FourthSectionComponent():ReactNode {
    // Creating States Of Component
    const [showingTest, setShowingTest] = useState(1);
                            ...
                            <div className={'mt-[100px] lg:max-w-[60%]'}>
                                <div className={'flex gap-[20px] mb-[30px]'}>
                                    ...
                                    <button
                                        ...
                                        className={'text-white'}
                                    >
                                        <IconComponent size={25} name={'chevron-right'} />
                                    </button>
                                </div>
                                <div>
                                    <TestemonialComponent img={MariaImage.src} name={'Mariana Racasan'} isOpened={(showingTest === 1)} role={'MARKETING DIRECTOR AT ZENHUB'}>SVZ was very responsive to the needs of our brand and worked in partnership with us to create a visual identity that feels authentic to our diverse team, users, and community. They not only delivered great results but were super responsive and excellent to work with.</TestemonialComponent>
                                    <TestemonialComponent img={VincentImage.src} name={'Vincent Huber'} isOpened={(showingTest === 2)} role={'Founder'}>We’ve had the pleasure to work with the SVZ team on a complete re-design of our website. We were highly impressed by their structured approach and organization, as well as their customer-centric approach to web design. We’re very happy with the final outcome and results!</TestemonialComponent>
                                    <TestemonialComponent img={TravisImage.src} name={'Travis Wingate'} isOpened={(showingTest === 3)} role={'VP @ SUPERMOVE.CO'}>“Working with the team at SVZ was nothing short of amazing. When I decided to revamp the Supermove Visual ID and website, I knew we would need support from an agency. After a long search, SVZ rose to the top of the list. Not only does their portfolio speak for itself, they are THE one-stop shop for branding, design and development"</TestemonialComponent>
                                </div>
                            </div>
                        </div>
                    </div>
